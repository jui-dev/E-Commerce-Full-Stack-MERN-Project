...
const App = () => {
  return (
    //----- Managing Routing ( for this install the package "react-router-dom") || import (BrowserRouter,Route, Routes, useLocation) at the top.
    <BrowserRouter>
      {/* Inside the (Browser Router) we will use the (Routes) */}
      <ScrollToTopOnNavigation />
      <Routes>
        {/* Inside the <Routes> --> <Route> */}
        {/* 1st provide the "path" and then "element" */}
